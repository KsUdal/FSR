...
/*
    ...
    for (i = 1; i < ih-1; i++) {
        for (j = 2; j < iw-1; j++) {
            MyImage[iw*i+j] = 0.1238*newIm[iw*i+j] + 0.1292*newIm[iw*(i+1)+j] + 0.1292*newIm[iw*(i-1)+j];
            MyImage[iw*i+j] = MyImage[iw*i+j] + 0.1292*newIm[iw*i+(j+1)] + 0.1292*newIm[iw*i+(j-1)];
            MyImage[iw*i+j] = MyImage[iw*i+j] + 0.0964*newIm[iw*(i+1)+(j+1)] + 0.0964*newIm[iw*(i+1)+(j-1)];
            MyImage[iw*i+j] = MyImage[iw*i+j] + 0.0964*newIm[iw*(i-1)+(j+1)] + 0.0964*newIm[iw*(i-1)+(j-1)];
        }
    }
*/
